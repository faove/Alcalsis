                                ...
                                <div class="art-vmenublock-body">
                                            ...
                                            <div class="art-vmenublockcontent">
                                                <div class="art-vmenublockcontent-body">
                                                            	...
                                                            	<li>
                                                            		<a title="Agregar, editar,estado de cuenta, liquidar, recaudar publicidades de los establecimientos" href="../publicidad.jsp?id_usuarios=<%=id_user%>&login=<%=login%>&pass=<%=passw%>&Pub=Publicidad"><span class="l"></span><span class="r"></span><span class="t">Publicidad Comercial</span></a>
                                                            				<ul>
...
---------------------
    ...
    %> 
			...
			<ul>		
			<font face="Arial Narrow"><input type="radio" value="1" checked name="opt_patente">N de Patente</font></font>
			

			<font face="Arial Narrow">
					<input type="radio" value="2"  name="opt_patente" style="height: 20px">Raz&oacuten Social</font></font>
			</ul>
				<ul> 
				<div id="demo" style="width:269px;height:24px">
				<div id="demoDer"  style="width: 194px; height: 24px">
				  <input type="text" style="width:269px;" id="input_2" class="input"
				...
				<ul>
					<font face="Arial Narrow"><input type="checkbox" name="check_mostrar" value="on">Mostrar 
				Coincidencias</font>
				</ul>
				...
				<div class="overview-table-inner">
					...
					<%
							...
							<a title="Agregar un Establecimiento Nuevo" href="../pic_agregar_est.jsp?id_usuarios=<%=id_user%>&agregar_est=1&pass=<%=pass%>&login=<%=login%>">Agregar Establecimiento</a> 
